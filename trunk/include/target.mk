...
DEFAULT_PACKAGES:=base-files uclibc busybox
# For router targets
DEFAULT_PACKAGES.router:=ppp iptables bridge
...
GENERIC_PATCH_DIR := $(GENERIC_PLATFORM_DIR)/patches$(shell [ -d "$(GENERIC_PLATFORM_DIR)/patches-$(LINUX_VERSION)" ] && printf -- "-$(LINUX_VERSION)" || true )
